...
use App\Exports\ExportSpMoving;
...
class SpMovingController extends Controller
{
    public function spMoving(Request $request)
    {
        $bulan = Helper::bulan();
        $data['title'] = 'SP Moving Status';
        ...
        return view('reporting/rpt_spMoving', $data,compact('bulan'));
    }

    public function spMoving_rpt(Request $request)
    {   
        // dd($request);
        ...
        $fileNm = "SP Moving Status ".$bln."_".$thn.".xlsx";
        return Excel::download(new ExportSpMoving($bln,$thn,$array), $fileNm);
