...
use App\Exports\ExportSpInventaris;
...
class SpInventarisController extends Controller
{
    public function spInventaris(Request $request)
    {
        $bulan = Helper::bulan();
        $data['title'] = 'SP Inventaris';
        ...
        return view('reporting/rpt_spInventaris', $data,compact('bulan'));
    }

    public function spInventaris_rpt(Request $request)
    {   
        // dd($request);
        ...
        $getSumNilai = DB::select(DB::raw("SELECT z.kdfa, z.nmfa, z.tgl_d_p_spbbm, z.nobpm, z.kdbrg, z.partnumb, z.ukur, z.qty, z.uom, z.h_beli, z.kdsts, z.ket_sts, z.ket
                                    FROM (
                                        ...
                                        WHERE a.kd_sts = '95' and a.kode_periode = '$gabYm'
        ...
        $fileNm = "SP-Inventaris-".$bln."_".$thn.".xlsx";
        return Excel::download(new ExportSpInventaris($bln,$thn,$array), $fileNm);
