...
class BbmRincPemPerUnitController extends Controller
{
    ...
    {   
        ...
        $getSumNilai = DB::select(DB::raw("SELECT z.nodoc, z.nmfa, z.tgl, z.kdbrg, z.nmbrg, z.ukur, z.quantity, z.satuan, z.nilai, z.sts, z.pemakaian, z.ket, z.hkawal, z.hkakhir, z.jamkrj, z.rata2, z.kdlok, z.nmlok, z.kdactiv, z.activalat
                                    ...
                                    WHERE a.tgl_det_p_spbbm >= '$sDate' and a.tgl_det_p_spbbm <= '$eDate' and b.kel_brg in ('MP991')
                                    ...
                                    WHERE a.tgl_det_p_bbm >= '$sDate' and a.tgl_det_p_bbm <= '$eDate' and b.kel_brg in ('MP991')
                                    ) z 
        ...
        $fileNm = "BBM-Rincian-Pemakaian-Per-Unit-".$sDt."_SD_".$eDt.".xlsx";
        return Excel::download(new ExportBbmRincPemPerUnit($sDt,$eDt,$array), $fileNm);
