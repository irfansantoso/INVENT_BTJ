...
class PemakaianSpBbmController extends Controller
{
    ...
    public function trHeaderPemakaianSpBbm_data(Request $request)
    {
        ...
        $data = DB::table(DB::raw("(SELECT tr_header_pemakaian_sp_bbm.*,mstr_lokasi.nama_lokasi as nmlok FROM tr_header_pemakaian_sp_bbm LEFT JOIN mstr_lokasi ON tr_header_pemakaian_sp_bbm.loc_activity = mstr_lokasi.kode_lokasi) as tis"));                                    
