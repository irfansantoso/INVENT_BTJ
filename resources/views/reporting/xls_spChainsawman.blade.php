    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            ...
            <td align="left" valign="bottom">&nbsp;</td>
            <td align="left" valign="bottom" style="font-size: 8;">DAFTAR PENGELUARAN BARANG</td>            
            <td align="left" valign="bottom"></td>
            <td align="left" valign="bottom"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="left" valign="bottom"></td>
            <td align="left" valign="bottom"></td>
            <td align="left" valign="bottom" style="font-size: 8;">PENGAMBILAN CHAINSAWMAN</td>
            <td align="left" valign="bottom"></td>
            <td align="left" valign="bottom"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="15" align="center" valign="middle" style="font-size: 8;border-bottom: 1px solid #000000;">Ukuran/Part No.</td>
            ...
            <td width="15" align="center" valign="middle" style="font-size: 8;border-bottom: 1px solid #000000;">Nilai</td>
            <td width="5" align="center" valign="middle" style="font-size: 8;border-bottom: 1px solid #000000;">Status</td>            
            <td width="25" align="center" valign="middle" style="font-size: 8;border-bottom: 1px solid #000000;">Pemakaian</td>
          ...
          @foreach ($getSumNilai as $gsn)
            ...
            <tr>
              ...
              <td align="left" valign="bottom" style="font-size: 8;">:</td>
              <td align="right" valign="bottom" style="font-size: 8;">{{$subHrgBeli}}</td>
              <td align="right" valign="bottom" style="font-size: 8;"></td>
              <td align="right" valign="bottom" style="font-size: 8;"></td>
            </tr>
            @php 
          ...
          <tr>
            ...
            <td align="right" valign="bottom" style="font-size: 8;">{{ $gsn['h_beli']; }}</td>
        ...
        <tfoot>
          ...
          <tr>
            ...
            <td align="left" valign="bottom" style="font-size: 8;">:</td>
            <td align="right" valign="bottom" style="font-size: 8;font-weight: bold;">{{$totalHrgBeli}}</td>
            <td align="right" valign="bottom" style="font-size: 8;"></td>
            <td align="right" valign="bottom" style="font-size: 8;"></td>
          </tr>
        </tfoot>    
