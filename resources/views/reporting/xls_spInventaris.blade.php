    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            ...
            <td align="left" valign="bottom">&nbsp;</td>
            <td align="left" valign="bottom" style="font-size: 8;">DAFTAR PENGELUARAN BARANG INVENTARIS</td>            
            <td align="left" valign="bottom"></td>
            <td align="left" valign="bottom"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="18" align="center" valign="middle" style="font-size: 8;border-bottom: 1px solid #000000;">Nama Barang</td>
            <td width="12" align="center" valign="middle" style="font-size: 8;border-bottom: 1px solid #000000;">Ukuran/Part No.</td>
            ...
            <td width="12" align="center" valign="middle" style="font-size: 8;border-bottom: 1px solid #000000;">Nilai</td>
            <td width="10" align="center" valign="middle" style="font-size: 8;border-bottom: 1px solid #000000;">Aktiva Tetap</td>
            <td width="12" align="center" valign="middle" style="font-size: 8;border-bottom: 1px solid #000000;">Nama Aktiva Tetap</td>
            <td width="5" align="center" valign="middle" style="font-size: 8;border-bottom: 1px solid #000000;">Status</td>            
            <td width="12" align="center" valign="middle" style="font-size: 8;border-bottom: 1px solid #000000;">Pemakaian</td>
            <td width="15" align="center" valign="middle" style="font-size: 8;border-bottom: 1px solid #000000;">Keterangan</td>
          </tr>
          <tr>
            <td></td>
          </tr>
          ...
          <tr>
            ...
            <td align="left" valign="bottom" style="font-size: 8;">{{ $gsn['nobpm']; }}</td>
