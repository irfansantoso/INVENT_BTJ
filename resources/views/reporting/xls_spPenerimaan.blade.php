    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <thead>
          <tr>
            ...
            <td align="left" valign="bottom">&nbsp;</td>
            <td align="left" valign="bottom" style="font-size: 8;">DAFTAR PENERIMAAN BARANG (S PART) by NO. DOCUMENT</td>            
            <td align="left" valign="bottom"></td>
            <td align="left" valign="bottom"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="left" valign="bottom" style="font-size: 8;">Jenis Transaksi : {{$kode_menu}} {{$jns_menu}}</td>
            <td align="center" valign="bottom"></td>
            <td align="center" valign="bottom"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="15" align="center" valign="middle" style="font-size: 8;border-bottom: 1px solid #000000;">Kode Barang</td>
            ...
            <td align="center" valign="bottom" style="font-size: 8;border-bottom: 1px solid #000000;">Nilai Bersih</td>
        ...
        @foreach ($getSumNilai as $gsn) 
          ...
          @if ($current_tr == $gsn['no_sppb'])
                  
            @else
            <tr>              
                @php ($current_tr = $gsn['no_sppb']) @endphp
                <td align="left" valign="bottom" style="font-size: 8;font-weight: bold;"></td>
            </tr>
          @endif

          <tr>
            <td align="left" valign="bottom" style="font-size: 8;">{{ date("d/m/Y", strtotime($gsn['tgl_sa'])); }}</td>
