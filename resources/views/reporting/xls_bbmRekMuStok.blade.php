    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <thead>
          <tr>
            ...
            <td align="left" valign="bottom" style="font-size: 8;">DAFTAR MUTASI PERSEDIAAN BBM DAN PELUMAS</td>
            <td align="left" valign="bottom"></td>
            <td align="left" valign="bottom"></td>
            <td align="left" valign="bottom"></td>
          </tr>
          ...
          <tr>
            ...
            <td width="20" align="center" valign="middle" rowspan="2" style="font-size: 8;font-weight: bold;">Unit/Alat</td>
            <td width="15" align="center" valign="middle" rowspan="2" style="font-size: 8;font-weight: bold;">Ukuran/Part No.</td>
        ...
        <tbody>
          ...
          @foreach ($getSumNilai as $gsn)
            ...
            <tr>
              ...
              <td align="right" valign="bottom" style="font-size: 8;">{{ number_format($gsn['saQty'], 2, ',', '.') }}</td>
              ...
              <td align="right" valign="bottom" style="font-size: 8;">{{ number_format($gsn['pengeluaranQty'], 2, ',', '.') }}</td>
              <td align="right" valign="bottom" style="font-size: 8;">{{ number_format($gsn['pengeluaran'], 2, ',', '.') }}</td>
              <td align="right" valign="bottom" style="font-size: 8;">{{ number_format($gsn['saldoAkhirQty'], 2, ',', '.') }}</td>
