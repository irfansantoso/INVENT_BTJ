        ...
        <table id="trDetailPinGudSpBbm" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>              
                ...
                <td>{{ $gds->nmfa }}</td>
                <td>{{ $gds->stspakai }}</td>
                <td>{{ $gds->tgl_det_p_spbbm }}</td>
                <td>                
                  <a href="#" data-toggle="modal" 
                  data-target="#modalEdit" 
                  data-id="{{ $gds->id }}"
                  data-id_head_p_spbbm="{{ $gds->id_head_p_spbbm }}"
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="card">
                      <!-- /.card-header -->
                      <div class="card-body">
                        <table id="stInvSpBbm_x" class="table table-bordered table-striped responsive">
                          <thead>
                          <tr>
                            <th>Kd_Brg</th>
                            <th>Kel_Brg</th>
...
$('#stInvSpBbm_x').DataTable({
  responsive: true,
  processing: true,
  serverSide: true,
  ajax: '{!! route('stInvSpBbmx.data') !!}', // memanggil route yang menampilkan data json
  columns: 
  [
    { // mengambil & menampilkan kolom sesuai tabel database
        data: 'kd_brg',
